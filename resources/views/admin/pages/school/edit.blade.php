...
@section('title', 'Admin| Edit Sekolah')
@section('content')
<div class="row">
    <div class="col-sm-12">
...
<div class="row">
    <div class="col-lg-12 col-sm-12">
        <div class="card">
            <div class="card-body">
                <form action={{ url('admin/school/update/'.$school->id) }} method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group row">
                        <label for="example-text-input" class="col-sm-2 col-form-label" for="name">Nama Sekolah</label>
                        <div class="col-sm-10">
                            <input class="form-control" type="text" placeholder="Isi Nama Sekolah" id="example-text-input" name="name" value="{{ $school->name }}">
                        </div>
                        @error('name')
